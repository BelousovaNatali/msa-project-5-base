import { DefaultRetryBackoffStrategy } from "@smithy/core/dist-es/submodules/retry/util-retry/DefaultRetryBackoffStrategy";
import { DefaultRetryToken } from "@smithy/core/dist-es/submodules/retry/util-retry/DefaultRetryToken";
import { DEFAULT_MAX_ATTEMPTS, RETRY_MODES } from "@smithy/core/dist-es/submodules/retry/util-retry/config";
import { INITIAL_RETRY_TOKENS, NO_RETRY_INCREMENT } from "@smithy/core/dist-es/submodules/retry/util-retry/constants";
import { Retry } from "@smithy/core/dist-es/submodules/retry/util-retry/retries-2026-config";
const refusal = {
    incompatible: 1,
    attempts: 2,
    capacity: 3,
