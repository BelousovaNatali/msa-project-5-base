import { NODE_REGION_CONFIG_OPTIONS } from "@smithy/core/dist-es/submodules/config/config-resolver/regionConfig/config";
import { loadConfig } from "@smithy/core/dist-es/submodules/config/node-config-provider/configLoader";
import { memoize } from "@smithy/core/dist-es/submodules/config/property-provider/memoize";
import { AWS_DEFAULT_REGION_ENV, AWS_EXECUTION_ENV, AWS_REGION_ENV, DEFAULTS_MODE_OPTIONS, ENV_IMDS_DISABLED, IMDS_REGION_PATH, } from "@smithy/core/dist-es/submodules/config/defaults-mode/constants";
import { NODE_DEFAULTS_MODE_CONFIG_OPTIONS } from "@smithy/core/dist-es/submodules/config/defaults-mode/defaultsModeConfig";
